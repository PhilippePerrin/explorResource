    ...
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 p-6" id="releases-page">
      <header className="space-y-2">
        ...
        <p className="max-w-3xl text-sm text-[var(--text-secondary)]">
          Manage release go-live dates, display colors, statuses, and linked projects. Releases are
          archived instead of deleted once any project is linked to them.
        </p>
      </header>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-collapse text-left text-sm">
                <caption className="sr-only">
                  Releases with go-live dates, linked projects, and actions.
                </caption>
                <thead>
      ...
      <section className="rounded-xl border border-[var(--surf-divider)] bg-[var(--surf-800)] p-5">
        ...
        {timelineGroups.length === 0 ? (
          <p className="mt-4 text-sm text-[var(--text-secondary)]">No releases scheduled yet.</p>
        ) : (
